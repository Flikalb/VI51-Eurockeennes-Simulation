    ...
    public FestivalPanel(GridStateChannel channel, JaakEnvironment environment) {
        ...
        this.addMouseListener(new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                _environment.getActionApplier().putObject(e.getX()/CELL_SIZE,
                        e.getY()/CELL_SIZE,
                        new FireSubstance(400));
        ...
        for(int x=0; x<this.width; ++x) {
            for(int y=0; y<this.height; ++y) {
                ...
                for(EnvironmentalObject eo : this.channel.getEnvironmentalObjects(x, y))
                {
                    ...
                    else if(eo instanceof FireSubstance)
                    {
                        g.setColor(new Color(255, 182, 193));//piiiink
                        g.fillRect(x*CELL_SIZE, y*CELL_SIZE, CELL_SIZE, CELL_SIZE);
                    }
